...
public class CalculoValorLocacaoTest {
    ...
    private static Filme filme2 = umFilme().agora(); // new Filme("Filme 2", 2, 4.0);
    private static Filme filme3 = umFilme().agora(); // new Filme("Filme 3", 2, 4.0);
    private static Filme filme4 = umFilme().agora(); // new Filme("Filme 4", 2, 4.0);
    private static Filme filme5 = umFilme().agora(); // new Filme("Filme 5", 2, 4.0);
    private static Filme filme6 = umFilme().agora(); // new Filme("Filme 6", 2, 4.0);
    private static Filme filme7 = umFilme().agora(); // new Filme("Filme 7", 2, 4.0);
